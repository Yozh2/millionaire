...
тем и контента кампаний: они загружаются лениво и хранятся в state страницы, так
что обычного module HMR недостаточно, чтобы уже открытая игра увидела свежий
`GameConfig`.
