...
- `public/asset-manifest.json`
  ...
  - Содержит ассеты движка, а также ассеты игр и кампаний.
...
Загружаемые ассеты:
- Иконки, изображения и звуки движка.
...
- Слайд-шоу хедера (`useHeaderImages`) тянет `manifest.json` из директории
  изображений и работает независимо от AssetLoader.
