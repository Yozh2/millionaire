...
Дата: 2025‑12‑15
Статус: done (Этапы 1–18 ✅; merged в `main`)
...
- 2025‑12‑15 (codex): ✅ Этап 18: обновлены `docs/refactoring_plan.md` и `README.md` (EN), удалены legacy артефакты (`docs/REFACTORING_ANALYSIS.md`, `docs/ENGINE_PLAN.md`, пустая `src/styles/`), `npm test/lint/build` зелёные, `refactoring` слит в `main`.
