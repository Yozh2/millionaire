...
const mockConfig = vi.hoisted(() => ({ id: 'mock-game' }) as GameConfig);
const selectorEntries = vi.hoisted<GameCatalogEntry[]>(() => [
  {
    kind: 'game',
    id: 'game-a',
    routePath: '/game-a',
...
vi.mock('./gameCatalog', () => ({
  getVisibleCatalogEntries: () => selectorEntries,
}));
...
const loadHook = async () => {
  ...
  const { LoadingProvider } =
    await import('@hub/screens/loading/LoadingOrchestrator');
