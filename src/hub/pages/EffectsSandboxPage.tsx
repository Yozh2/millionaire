    ...
    const drawEffects: Record<DemoId, (progress: number) => void> = {
      ...
      smoke: (progress) => {
        ...
        for (let i = 0; i < 5; i++) {
          ...
          gradient.addColorStop(
            0,
            `rgba(150, 150, 160, ${0.3 - progress * 0.2})`,
          );
          gradient.addColorStop(1, 'transparent');
      ...
      snow: (progress) => {
        ...
        for (let i = 0; i < 30; i++) {
          ...
          const y =
            ((i * 47 + progress * canvas.height * 2) % (canvas.height + 20)) -
            10;
          const size = 2 + (i % 4);
...
export function EffectsSandboxPage() {
  ...
  const triggerEffect = (name: string, fn: () => void) => {
    setLastEffect(name);
    fn();
  };
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <button
              onClick={() =>
                triggerEffect('Fireworks', () => effects.triggerFireworks())
              }
              ...
              <div className="flex gap-4 flex-wrap">
                <button
                  ...
                  style={{
                    ...
                    boxShadow:
                      '0 5px 20px rgba(0, 0, 0, 0.3), 0 0 25px rgba(255, 180, 0, 0.3)',
                    borderStyle: 'ridge',
                  }}
                >
                  🎮 Начать игру
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow:
                      '0 5px 20px rgba(0, 0, 0, 0.3), 0 0 25px rgba(0, 150, 255, 0.3)',
                    borderStyle: 'ridge',
                  }}
                >
                  🔄 Новая игра
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow:
                      '0 5px 20px rgba(0, 0, 0, 0.3), 0 0 25px rgba(255, 50, 50, 0.3)',
                    borderStyle: 'ridge',
                  }}
                >
                  💀 Dark Mode
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-400 mb-6 text-sm">
            Ниже показаны дополнительные эффекты, которые можно реализовать с
            помощью Canvas API. Нажимай на карточки, чтобы увидеть
            демо-анимации.
          </p>
