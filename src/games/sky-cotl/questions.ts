...
export const skyJourneyQuestionPool: QuestionPool = {
  easy: [
    {
      ...
      answers: ['thatgamecompany', 'Nintendo', 'Mojang', 'Valve'],
      correct: 0,
    },
    {
    ...
    {
      question: 'What is a common in-game currency used for cosmetics?',
      answers: ['Candles', 'Gems', 'Gold', 'Tickets'],
      correct: 0,
    },
  ],
  medium: [
    {
      question: 'Which realm is known for wide open fields and daylight?',
      answers: ['Daylight Prairie', 'Hidden Forest', 'Golden Wasteland', 'Vault of Knowledge'],
      correct: 0,
    },
    {
    ...
    {
      question: 'What are Hearts commonly used for?',
      answers: ['Friendship gifts and cosmetics', 'Fast travel', 'Extra lives', 'Crafting materials'],
      correct: 0,
    },
    {
  ...
  hard: [
    ...
    {
      question: 'What is the name of the final, high-stakes area of the main journey?',
      answers: ['Eye of Eden', 'Star Sanctuary', 'The Abyss', 'Crystal Cavern'],
      correct: 0,
    },
    {
      question: 'What can you lose when you’re hit by dark creatures or hazards?',
      answers: ['Winged Light', 'Account level', 'Unlocked emotes', 'Cosmetics'],
      correct: 0,
    },
    {
