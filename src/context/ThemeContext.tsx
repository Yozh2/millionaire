/**
 * Theme context for dynamic color scheme based on selected difficulty mode.
...
/** Get theme colors based on difficulty mode */
export const getThemeColors = (mode: DifficultyMode | null): ThemeColors => {
  if (!mode || mode === 'hero') {
    return {
      primary: 'amber',
...
/** Default theme (amber/hero) */
const defaultTheme = getThemeColors(null);
