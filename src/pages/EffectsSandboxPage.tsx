          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button className="answer-btn px-4 py-3 bg-gradient-to-b from-stone-700 to-stone-900 text-amber-100 border-4 border-stone-600 text-left">
                  <span className="text-amber-400 mr-2 font-bold">[A]</span>
                  Наведи и нажми
                </button>
                <button className="answer-btn px-4 py-3 bg-gradient-to-b from-green-700 to-green-900 text-green-100 border-4 border-green-500 text-left">
            ...
            <div>
              ...
              <div className="flex gap-4 flex-wrap">
                <button
                  className="action-btn px-8 py-3 bg-gradient-to-b from-amber-600 to-amber-800 text-white font-bold border-4 border-amber-500"
                  style={{
                ...
                <button
                  className="action-btn px-8 py-3 bg-gradient-to-b from-blue-600 to-blue-800 text-white font-bold border-4 border-blue-500"
                  style={{
                ...
                <button
                  className="action-btn px-8 py-3 bg-gradient-to-b from-red-600 to-red-800 text-white font-bold border-4 border-red-500"
                  style={{
